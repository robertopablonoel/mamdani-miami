...
export type IncomeBracket = 'under_100k' | '100k_150k' | '150k_250k' | '250k_400k' | '400k_750k' | '750k_1m' | '1m_1.5m' | '1.5m_2m' | 'over_2m' | 'prefer_not_say';
export type AgeBracket = 'under_30' | '30_39' | '40_49' | '50_59' | '60_plus';
...
export const quizAnswersSchema = z.object({
  ...
  income_bracket: z.enum(['under_100k', '100k_150k', '150k_250k', '250k_400k', '400k_750k', '750k_1m', '1m_1.5m', '1.5m_2m', 'over_2m', 'prefer_not_say']),
  age_bracket: z.enum(['under_30', '30_39', '40_49', '50_59', '60_plus']),
