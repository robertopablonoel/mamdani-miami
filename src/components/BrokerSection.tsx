...
Your Escape Facilitator.</h2>
              ...
              <div className="space-y-5 md:space-y-6 mt-5 md:mt-6">
                ...
                <div className="flex flex-wrap gap-3 md:gap-3 px-2">
                  ...
                  <div className="bg-accent px-4 md:px-4 py-2 md:py-2 rounded-full text-sm md:text-sm font-medium text-foreground border border-border">$185M+ Volume in 2025</div>
                </div>
